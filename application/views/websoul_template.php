...
<META NAME="ROBOTS" CONTENT="NONE">
   ...
   document.write('<div align="right" id="loading" style="float:right;padding:10px;"><img align="absmiddle" src="<?php echo base_url(); ?>assets/images/loaders/loader7.gif"></div>');
    window.onload=function(){
		...
		<link rel="stylesheet" href="<?php echo site_url();?>assets/css/websoul/blue.css" type="text/css" media="screen" />
		
		<link rel="stylesheet" href="<?php echo site_url();?>assets/css/websoul/red.css" type="text/css" media="screen" />  
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="<?php echo site_url(); ?>assets/images/websoul/logo.png" alt="Simpla Admin logo" /></a>
	...
	<li><a class="nav-top-item no-submenu <?php echo (preg_match("/websoul\/article/",$_SERVER['REQUEST_URI']))?"current":""; ?>" href="<?php echo site_url('websoul/article');?>">Article</a>
        ...
        <li><a class="nav-top-item no-submenu <?php echo (preg_match("/websoul\/event/",$_SERVER['REQUEST_URI']))?"current":""; ?>" href="<?php echo site_url('websoul/event');?>">Events</a>
	</li>
			</ul> <!-- End #main-nav -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div id="footer">
				<small> <!-- Remove this notice or replace it with whatever you want -->
						Copyright 2013 - | Powered by <a href="http://www.digify.us">Digify</a> | <a href="#">Top</a>
				</small>
			</div><!-- End #footer -->
