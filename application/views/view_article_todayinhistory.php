...
<div id="breadcrumb">
	<div class="bc_left">
		<img src="<?php echo base_url(); ?>assets/images/bnl_icon.png" /> > Articles > Today In History
	</div>
</div>
<div class="clear"></div>
<div class="container">
	<div id="content" class="funfacts_page">
		<span class="title title_style">Today In History</span>
